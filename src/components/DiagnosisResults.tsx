...
export default function DiagnosisResults({ image, results, mode, onReset }: DiagnosisResultsProps) {
      ...
      <div className="flex flex-col gap-6 w-full h-full">
        ...
        <div className="flex gap-4 shrink-0">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={onReset}
            className="flex-1 bg-white border border-gray-200 text-gray-700 rounded-xl py-3 font-semibold text-sm shadow-sm"
          >
            New Diagnosis
          </motion.button>
          <motion.button
            whileHover={{ scale: 1.02, backgroundColor: "#1e2f44" }}
            whileTap={{ scale: 0.98 }}
            className="flex-1 bg-[#273d58] text-white rounded-xl py-3 font-semibold text-sm shadow-sm"
          >
